% Chebyshev filter design compact as separate code is looong
clc;
clear all;
close all;
...
function graph(fft_y1,fft_x,h,fr,order,k,t,action)
    ...
    switch true
        case (k=='c' && t==1 && action=='l')
            title_str = 'Output sequence - Low pass chebyshev filter type 1';
        case (k=='c' && t==2 && action=='l')
            title_str = 'Output sequence - Low pass chebyshev filter type 2';
        case (k=='c' && t==1 && action=='h')
            title_str = 'Output sequence - High pass chebyshev filter type 1';
        case (k=='c' && t==2 && action=='h')
            title_str = 'Output sequence - High pass chebyshev filter type 2';
        case (k=='c' && t==1 && action=='p')
            title_str = 'Output sequence - Band pass chebyshev filter type 1';
        case (k=='c' && t==2 && action=='p')
            title_str = 'Output sequence - Band pass chebyshev filter type 2';
        case (k=='c' && t==1 && action=='s')
            title_str = 'Output sequence - Band stop chebyshev filter type 1';
        case (k=='c' && t==2 && action=='s')
            title_str = 'Output sequence - Band stop chebyshev filter type 2';
        otherwise
            title_str = 'Output Sequence';  % Default title
    end
